...
// An overhead view of the city: six districts, each showing how many citizens are
// there right now. Polls on its own so it stays live while you watch.
"use client"
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
        {districts.map((d) => {
          ...
          return (
            ...
            >
              {/* subtle "heat" fill: busier districts glow more */}
              <div
