// app/api/citymap/route.ts
// Live count of alive citizens per district. Self-contained: reads agents grouped
// by location and fills in any empty districts so all six always render.
